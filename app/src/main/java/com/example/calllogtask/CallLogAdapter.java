package com.example.calllogtask;
...
public class CallLogAdapter extends RecyclerView.Adapter<CallLogAdapter.CallHolder> {
    ...
    @NonNull
    @Override
    public CallLogAdapter.CallHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull CallLogAdapter.CallHolder holder, int position) {
        ...
        holder.duration.setText(callLogModelList.get(position).getDuration()+" Sec");
         ...
         int p2 = seconds /60;
         int p3 = p2 % 60;
         holder.duration.setText(p2 + "hrs :"+ p3 + "mins: " + p1 +"sec");
         ...
         else if(p3==0)
         {
             ...
             holder.duration.setText(p3 + " mins" + " secs");
         }
